...
export function autobind() {
  return function (target: Constructor | Record<string, any>, prop?: string, descriptor?: PropertyDescriptor): any {
...
function bindMethod(target: Record<string, any>, prop?: string, descriptor?: PropertyDescriptor) {
  ...
  const boundFunc = new WeakMap<Record<string, any>, (...a: any[]) => any>()
