...
import { JsonApiData } from "../../api/json-api"
...
export class ReleaseStore extends ItemStore<HelmRelease> {
  ...
  async loadItems(namespaces?: string[]): Promise<HelmRelease[]> {
    if (!namespaces) {
  ...
  async rollback(name: string, namespace: string, revision: number): Promise<JsonApiData> {
