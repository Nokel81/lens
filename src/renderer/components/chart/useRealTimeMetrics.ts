...
type MetricValues = [number, string][];
type ChartData = { x: number; y: string }[]
...
export function useRealTimeMetrics(metrics: MetricValues, chartData: ChartData, params = defaultParams): ChartData {
