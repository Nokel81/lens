...
export interface PrometheusPathParts {
  namespace: string;
  service: string;
  port: number;
  prefix: string;
...
export class ClusterPrometheusSetting extends React.Component<Props> {
  ...
  @computed get canEditPrometheusPath(): boolean {
    return this.provider !== "" && this.provider !== "lens"
  }
  ...
  parsePrometheusPath = (): null | PrometheusPathParts => {
    ...
    return (
      <>
        ...
        <p>
          ...
          <a href="https://github.com/lensapp/lens/blob/master/troubleshooting/custom-prometheus.md" rel="noreferrer" target="_blank">guide</a>{" "}
